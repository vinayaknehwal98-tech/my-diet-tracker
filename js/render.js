  ...
  html += `
    <div class="section-toolbar">
      ...
      <div class="section-actions">
        <button class="import-btn" type="button" onclick="openImportModal()">Import Diet</button>
        <button class="import-btn" type="button" onclick="openSnapModal(null, null)">Log Extra</button>
      </div>
    </div>`;
